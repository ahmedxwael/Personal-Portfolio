...
const Header = () => {
	...
	return (
		<header className="z-[999] relative">
			<motion.nav
				className="absolute flex items-center justify-center left-1/2 border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] top-4 sm:top-6 w-[28rem] sm:w-[36rem] max-w-full rounded-2xl sm:rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"
